            ...
            <div class="card-body register-card-body">
                ...
                <form action="{{ $register_url }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="prenom" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('prenom') }}"
                    ...
                    <button class="btn btn-info btn-rounded btn-sm " type="button" data-toggle="collapse"
                        ...
                        Upload New Photo
                    </button> <span> <em>( Optionnelle )</em></span>

                    <div class="collapse " id="collapseExample">
                        <div class="form-group">
                            <input  type="file" name="img_profil" class="form-control-file" id="exampleFormControlFile1">
                        </div>
                    </div> <br> <br>
